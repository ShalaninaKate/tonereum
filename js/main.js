...
/* harmony import */ var _components_parallax_mouse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/parallax-mouse */ "./src/js/components/parallax-mouse.js");
/* harmony import */ var _components_parallax_mouse__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_parallax_mouse__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./src/js/components/parallax-mouse.js":
/*!*********************************************!*\
  !*** ./src/js/components/parallax-mouse.js ***!
  \*********************************************/
/***/ (() => {
  ...
  paralaxMouseInit(paralaxMouse) {
    paralaxMouse.forEach(el => {
      ...
      function mouseMoveParalax() {
        let wrapper = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window;
...
function initSliders() {
  if (document.querySelector('.partners-slider')) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners-slider', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard, swiper__WEBPACK_IMPORTED_MODULE_0__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay],
      observer: true,
      observeParents: true,
      slidesPerView: 'auto',
      spaceBetween: 30,
...
const radius = 122; // Радиус диаграммы
const centerX = 0;
const centerY = 0;
let startAngle = -Math.PI / 2; // Начинать с верхней точки (12 часов)
...
data.forEach(segment => {
  ...
  // Создание элемента <text> для подписи
